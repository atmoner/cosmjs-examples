---
title: DelegatorUnbondingDelegations()
author: atmon3r
icon: file
copyright: false
---
...
## Example
```js
let DelegatorUnbondingDelegations = await querystaking.DelegatorUnbondingDelegations({
    "delegatorAddr": ""
})
console.log(DelegatorUnbondingDelegations)
```
