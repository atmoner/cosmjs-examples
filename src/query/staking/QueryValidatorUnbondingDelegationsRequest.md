---
title: ValidatorUnbondingDelegations()
author: atmon3r
icon: file
copyright: false
---
...
## Example
```js
let ValidatorUnbondingDelegations = await querystaking.ValidatorUnbondingDelegations({
    "validatorAddr": ""
})
console.log(ValidatorUnbondingDelegations)
```
